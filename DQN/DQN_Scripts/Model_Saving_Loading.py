...
def load_model_dict(path, name, policy_net, optimizer, starting_point, episode_reward_tracker, total_steps, memory):
    """
...
def save_model_dict(path, name, policy_net, optimizer, starting_point, episode_reward_tracker, total_steps, memory):
    """
